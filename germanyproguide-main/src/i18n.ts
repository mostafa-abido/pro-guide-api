  ...
  ar: {
    translation: {
      ...
      booking: {
        ...
        time: 'الوقت',
        date: 'التاريخ',
        durationMinutes: 'لمدة {{minutes}} دقيقة',
        booked: 'محجوز',
        noSlots: 'لا توجد مواعيد متاحة حالياً',
        noSlotsForDate: 'لا توجد مواعيد في هذا التاريخ',
        loading: 'جاري تحميل المواعيد...',
        slotsOnDate: 'مواعيد يوم {{date}}',
        clearDateFilter: 'عرض كل المواعيد',
        pickDateHint: 'اختر تاريخاً لعرض المواعيد المتاحة',
        ...
        paymentSuccessTitle: 'تم الحجز بنجاح!',
        paymentSuccessMessage: 'شكراً لك. تم تأكيد موعدك بعد إتمام الدفع.',
        paymentFailedTitle: 'لم يتم تأكيد الحجز',
        paymentFailed: 'تعذر تأكيد الدفع',
        backToSlots: 'العودة للمواعيد',
        tryAgain: 'حاول مرة أخرى',
        paymentCancelled: 'تم إلغاء الدفع. يمكنك اختيار موعد آخر.',
      },
      footer: {
  ...
  de: {
    translation: {
      ...
      booking: {
        ...
        noSlotsForDate: 'Keine Termine an diesem Datum',
        loading: 'Termine werden geladen...',
        slotsOnDate: 'Termine am {{date}}',
        clearDateFilter: 'Alle Termine anzeigen',
        pickDateHint: 'Wählen Sie ein Datum, um verfügbare Termine zu sehen',
        checkoutTitle: 'Buchung abschließen',
        ...
        paymentSuccessTitle: 'Buchung erfolgreich!',
        paymentSuccessMessage: 'Vielen Dank. Ihr Termin wurde nach der Zahlung bestätigt.',
        paymentFailedTitle: 'Buchung nicht bestätigt',
        paymentFailed: 'Zahlung konnte nicht bestätigt werden',
        backToSlots: 'Zurück zu den Terminen',
        tryAgain: 'Erneut versuchen',
        paymentCancelled: 'Zahlung abgebrochen. Sie können einen anderen Termin wählen.',
      },
      footer: {
  ...
  en: {
    translation: {
      ...
      booking: {
        ...
        time: 'Time',
        date: 'Date',
        durationMinutes: 'For {{minutes}} minutes',
        booked: 'BOOKED',
        noSlots: 'No slots available at the moment',
        noSlotsForDate: 'No slots on this date',
        loading: 'Loading slots...',
        slotsOnDate: 'Slots on {{date}}',
        clearDateFilter: 'Show all slots',
        pickDateHint: 'Pick a date to see available slots',
        ...
        paymentSuccessMessage: 'Thank you. Your appointment is confirmed after payment.',
        paymentFailedTitle: 'Booking not confirmed',
        paymentFailed: 'Could not confirm payment',
        backToSlots: 'Back to slots',
        tryAgain: 'Try again',
        paymentCancelled: 'Payment was cancelled. You can choose another slot.',
      },
      footer: {
